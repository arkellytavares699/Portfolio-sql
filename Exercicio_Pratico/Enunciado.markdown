...
estágios dos seus alunos em empresas. O objetivo é registar e acompanhar os estágios 
...
Requisitos: 
1. Criar a base de dados e as tabelas em SQL. 
2. Inserir dados fictícios em todas as tabelas (mínimo de 5 registos por 
tabela). 
3. Criar as seguintes consultas em SQL: 
