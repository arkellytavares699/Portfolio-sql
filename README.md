...
Este repositório contém os trabalhos que desenvolvi durante a formação em SQL, desde exercícios básicos até projetos avançados.  
Inclui códigos, consultas e scripts que exemplificam a criação, manipulação e consulta de dados em **MySQL**.
...
- **Atualização e exclusão de registros:** `UPDATE`, `DELETE`  
...
- Estruturação de consultas eficientes e corretas  
